/*
 * cmdatatagutils.js 
 * $Author: abrink $:  $Date: 2010-11-15 09:58:00 -0500 (Mon, 15 Nov 2010) $:
 * $Rev: 160246 $
 *
 * Version 4.1.0
 *
 ...
 * 26 Jan 2010	CMICHAEL. This library was not in SVN. Downloaded existing library from site and placed in SVN
 *			Work to add support for currency conversion. Changes to Shop Action, Order and calls to Maketag
 *
 */
 
var cm_ClientID = "90374021";
var cm_TrackLink = "A";
...
function cmSetProduction(){
	...
	cm_JSFPCookieDomain = "urbanoutfitters.de";
}
...
function cmCreateShopAction5Tag(productID,productName,productQuantity,productPrice,categoryID) { 
	...
	cmAddShop(["pr",productID,"pm",productName,"qt",productQuantity,"bp",productPrice,"cg",categoryID,"cc",cm_currencyCode,"at","5","tid","4","pc","N"]);  
...
function cmCreateShopAction9Tag(productID,productName,productQuantity,productPrice,customerID,orderID,orderTotal,categoryID) {  
	...
	cmAddShop(["pr",productID,"pm",productName,"qt",productQuantity,"bp",productPrice,"cg",categoryID,"cc",cm_currencyCode,"cd",customerID,"on",orderID,"tr",orderTotal,"at","9","tid","4","pc","N"]);  //amendment 1  - added '"cc",currency' to values passed to addshop
...
function cmCreateOrderTag(orderID,orderTotal,orderShipping,customerID,customerCity,customerState,customerZIP) {  
	...
	orderTotal = orderTotal.toString().replace(pattern, "");
	cmMakeTag(["tid","3","osk",__skuString,"on",orderID,"tr",orderTotal,"sg",orderShipping,"cd",customerID,"ct",customerCity,"sa",customerState,"zp",customerZIP,"cc",cm_currencyCode]);   
	__skuString = "";
}
...
function cmGetDefaultPageID() { 
	...
	if (slashPos == pageName.length - 1) {
		pageName = pageName + "http://www.urbanoutfitters.de/Vans-Check-+amp-Leather-Denim-59-Era/invt/default.asp"; /****************** SET TO DEFAULT DOC NAME */
	}
