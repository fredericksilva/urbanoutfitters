...
(function (D, s, k) {
    ...
    (function (a, c) {
        if (a.cleanData) {
            ...
            a.cleanData = function (f) {
                for (var d = 0, g;
                (g = f[d]) != null; d++) a(g).triggerHandler("remove");
                b(f)
            }
        } else {
            var e = a.fn.remove;
        ...
        a.widget.bridge = function (b, d) {
            a.fn[b] = function (g) {
                ...
                e ? this.each(function () {
                    ...
                    var c = a.data(this, b);
                    c ? c.option(g || {})._init() : a.data(this, b, new d(g, this))
                });
                return o
            }
        };
    ...
    (function (a) {
        ...
        a.mobile.media = function () {
            var b = {}, e = a("<div id='jquery-mediatest'>"),
                f = a("<body>").append(e);
            return function (a) {
                if (!(a in b)) {
    ...
    (function (a, c) {
        ...
        function e(a, b, c) {
            ...
            for (i = 0; i < c.length; i++) {
                var e = c[i],
                    ...
                    e = e.charAt(0).toUpperCase() + e.substr(1) + (a.charAt(0).toUpperCase() + a.substr(1));
        ...
        a.extend(a.support, {
            ...
            scrollTop: ("pageXOffset" in s || "scrollTop" in k.documentElement || "scrollTop" in f[0]) && !h && !j,
        ...
        a.event.special.swipe = {
            ...
            setup: function () {
                ...
                c.bind(d, function (d) {
                    ...
                    var e = d.originalEvent.touches ? d.originalEvent.touches[0] : d,
                        l = {
                            time: (new Date).getTime(),
        ...
        var e = function (d) {
            ...
            return function (b, f, e, o) {
                var k = new a.Deferred,
                    ...
                    q = !a.support.cssTransitions || n || !b || b === "none",
                    t = function () {
    ...
    (function (a, c) {
        function b(b) {
            r && (!r.closest(".ui-page-active").length || b) && r.removeClass(a.mobile.activeBtnClass);
            r = null
        }
        function e() {
            t = false;
        ...
        var p = a("head"),
            l = {
                ...
                makeUrlAbsolute: function (a, b) {
                    ...
                    return f + e + g + j + (c.search || !h && d.search || "") + c.hash
                },
                ...
                isFirstPageUrl: function (b) {
                    var b = l.parseUrl(l.makeUrlAbsolute(b, v)),
        ...
        a.mobile.loadPage = function (b, d) {
            ...
            !a.mobile.allowCrossDomainPages && !l.isSameDomain(w, k) ? f.reject(k, d) : a.ajax({
                ...
                success: function (c, o, m) {
                    ...
                    h(g, e.role);
                    k.indexOf("&" + a.mobile.subPageUrlKey) > -1 && (g = e.pageContainer.children(":jqmData(url='" + n + "')"));
        ...
        a.mobile._registerInternalEvents = function () {
                ...
                if (a.mobile.linkBindingEnabled) {
                    ...
                    if (f && !(d.which > 1) && e.jqmHijackable().length) {
                        ...
                        if (!a.mobile.ajaxEnabled && !l.isEmbeddedPage(f)) g();
                            ...
                            h || l.isExternal(f) && !k ? g() : (g = e.jqmData("transition"), h = (h = e.jqmData("direction")) && h === "reverse" || e.jqmData("back"), e = e.attr("data-" + a.mobile.ns + "rel") || c, a.mobile.changePage(f, {
                                transition: g,
                                reverse: h,
                                role: e
                            }), d.preventDefault())
            ...
            a.mobile._handleHashChange = function (b) {
                ...
                if (!a.mobile.hashListeningEnabled || n.ignoreNextHashChange) n.ignoreNextHashChange = false;
                    ...
                    d ? (d = typeof d === "string" && !l.isPath(d) ? l.makeUrlAbsolute("#" + d, v) : d, a.mobile.changePage(d, f)) : a.mobile.changePage(a.mobile.firstPage, f)
                }
            };
    ...
    (function (a) {
        a.fn.grid = function (c) {
            return this.each(function () {
                ...
                if (!e) if (f.length <= 5) for (var g in d) d[g] === f.length && (e = g);
                else e = "a";
                d = d[e];
    ...
    (function (a, c) {
        ...
        a.fn.buttonMarkup = function (b) {
            for (var b = b && a.type(b) == "object" ? b : {}, d = 0; d < this.length; d++) {
                var g = this.eq(d),
                    h = g[0],
                    j = a.extend({}, a.fn.buttonMarkup.defaults, {
                ...
                (q = a.data(h.tagName === "INPUT" || h.tagName === "BUTTON" ? h.parentNode : h, "buttonElements")) ? (h = q.outer, g = a(h), l = q.inner, r = q.text, a(q.icon).remove(), q.icon = null) : (l = k.createElement(j.wrapperEls), r = k.createElement(j.wrapperEls));
                ...
                q || l.appendChild(r);
                if (n && (n.className = p, !q || !q.icon)) n.appendChild(k.createTextNode("\u00a0")), l.appendChild(n);
        ...
        var e = function () {
            ...
            a(k).bind({
                "vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart": function (e) {
                    ...
                    }, c) : k.removeClass("ui-btn-up-" + j).addClass("ui-btn-hover-" + j);
    ...
    (function (a) {
        a.widget("mobile.collapsible", a.mobile.widget, {
            ...
            _create: function () {
                ...
                d.addClass(b.contentTheme ? "ui-body-" + b.contentTheme : "");
    ...
    (function (a) {
        ...
        a.widget("mobile.listview", a.mobile.widget, {
            ...
            _addThumbClasses: function (b) {
                var c, f, d = b.length;
                for (c = 0; c < d; c++) f = a(this._findFirstElementByTagName(b[c].firstChild, "nextSibling", "img", "IMG")), f.length && (f.addClass("ui-li-thumb"), a(this._findFirstElementByTagName(f[0].parentNode, "parentNode", "li", "LI")).addClass(f.is(".ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb"))
            },
            refresh: function (b) {
                ...
                var c = this.options,
                    f = this.element,
                    d = f.jqmData("dividertheme") || c.dividerTheme,
                    g = f.jqmData("splittheme"),
                    h = f.jqmData("spliticon"),
                    j = this._getChildrenByTagName(f[0], "li", "LI"),
                    o = a.support.cssPseudoElement || !a.nodeName(f[0], "ol") ? 0 : 1,
                    m = {}, p, l, r, n, q, t, x;
                ...
                for (var u = 0, w = j.length; u < w; u++) {
                    ...
                    if (b || !p.hasClass("ui-li")) r = p.jqmData("theme") || c.theme, n = this._getChildrenByTagName(p[0], "a", "A"), n.length ? (t = p.jqmData("icon"), p.buttonMarkup({
                        ...
                        theme: r
                    }), t != false && n.length == 1 && p.addClass("ui-li-has-arrow"), n.first().removeClass("ui-link").addClass("ui-link-inherit"), n.length > 1 && (l += " ui-li-has-alt", n = n.last(), q = g || n.jqmData("theme") || c.splitTheme, x = n.jqmData("icon"), n.appendTo(p).attr("title", n.getEncodedText()).addClass("ui-li-link-alt").empty().buttonMarkup({
                        shadow: false,
                        corners: false,
                        theme: r,
                        icon: false,
                    ...
                    o && l.indexOf("ui-li-divider") < 0 && (r = p.is(".ui-li-static:first") ? p : p.find(".ui-link-inherit"), r.addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>" + o+++". </span>"));
                    m[l] || (m[l] = []);
                    m[l].push(p[0])
                }
            ...
            _createSubPages: function () {
                var b = this.element,
                    ...
                    j = "data-" + a.mobile.ns,
                    k = this,
                    m = e.find(":jqmData(role='footer')").jqmData("id"),
                    p;
                ...
                a(b.find("li>ul, li>ol").toArray().reverse()).each(function (c) {
                    ...
                    p = true;
                    d.detach().wrap("<div " + j + "role='page' " + j + "url='" + e + "' " + j + "theme='" + x + "' " + j + "count-theme='" + u + "'><div " + j + "role='content'></div></div>").parent().before("<div " + j + "role='header' " + j + "theme='" + h.headerTheme + "'><div class='ui-title'>" + o + "</div></div>").after(m ? a("<div " + j + "role='footer' " + j + "id='" + m + "'>") : "").parent().appendTo(a.mobile.pageContainer).page();
                    d = c.find("a:first");
            ...
            _create: function () {
                ...
                if (!(g !== "checkbox" && g !== "radio")) {
                    a.extend(this, {
                        label: d,
                        inputtype: g,
                        checkedClass: "ui-" + h + (o ? "" : " " + a.mobile.activeBtnClass),
                        uncheckedClass: "ui-" + j,
        ...
        a.widget("mobile.button", a.mobile.widget, {
            ...
            _create: function () {
                ...
                if (b[0].tagName === "A")!b.hasClass("ui-btn") && b.buttonMarkup();
                    ...
                    if (!this.options.theme) this.options.theme = a.mobile.getInheritedTheme(this.element, "c");~b[0].className.indexOf("ui-btn-left") && (d = "ui-btn-left");~b[0].className.indexOf("ui-btn-right") && (d = "ui-btn-right");
    ...
    (function (a) {
        a.fn.controlgroup = function (c) {
            ...
            return this.each(function () {
                ...
                b(e.find(".ui-btn" + (f.excludeInvisible ? ":visible" : "")).not(".ui-slider-handle"), g);
    ...
    (function (a) {
        ...
        a.mobile.widget, {
            ...
            _create: function () {
                var c = this.element,
                    b = this.options,
                    e = b.theme || a.mobile.getInheritedTheme(this.element, "c"),
                    f = " ui-body-" + e,
                    d = c.jqmData("mini") == true,
                    g = d ? " ui-mini" : "",
                    h, j;
                ...
                c.is("[type='search'],:jqmData(type='search')") ? (h = c.wrap("<div class='ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield" + f + g + "'></div>").parent(), j = a("<a href='#' class='ui-input-clear' title='" + b.clearSearchButtonText + "'>" + b.clearSearchButtonText + "</a>").bind("click", function (a) {
        ...
        a(k).delegate(":jqmData(role='listview')", "listviewcreate", function () {
            ...
            if (b.options.filter) {
                ...
                a("<input>", {
                    ...
                    if (d) {
                        for (var k = g.length - 1; k >= 0; k--) e = a(g[k]), j = e.jqmData("filtertext") || e.text(), e.is("li:jqmData(role=list-divider)") ? (e.toggleClass("ui-filter-hidequeue", !h), h = false) : b.options.filterCallback(j, d) ? e.toggleClass("ui-filter-hidequeue", true) : h = true;
        ...
        a.widget("mobile.slider", a.mobile.widget, {
            ...
            _create: function () {
                var b = this,
                    ...
                    j = a("[for='" + j + "']").attr("id", o),
                    m = function () {
                        return g == "input" ? parseFloat(e.val()) : e[0].selectedIndex
    ...
    (function (a) {
        a.widget("mobile.selectmenu", a.mobile.widget, {
            ...
            _create: function () {
                ...
                var c = this,
                    b = this.options,
                    e = this.button.text(a(this.select[0].options.item(this.select[0].selectedIndex == -1 ? 0 : this.select[0].selectedIndex)).text()).insertBefore(this.select).buttonMarkup({
                        theme: b.theme,
                        icon: b.icon,
                        iconpos: b.iconpos,
                        inline: b.inline,
    ...
    (function (a) {
        var c = function (b) {
            var c = b.selectID,
                f = b.label,
                d = b.select.closest(".ui-page"),
                g = a("<div>", {
                    "class": "ui-selectmenu-screen ui-screen-hidden"
                }).appendTo(d),
                h = b._selectOptions(),
                j = b.isMultiple = b.select[0].multiple,
                o = c + "-button",
                m = c + "-menu",
                p = a("<div data-" + a.mobile.ns + "role='dialog' data-" + a.mobile.ns + "theme='" + b.options.theme + "' data-" + a.mobile.ns + "overlay-theme='" + b.options.overlayTheme + "'><div data-" + a.mobile.ns + "role='header'><div class='ui-title'>" + f.getEncodedText() + "</div></div><div data-" + a.mobile.ns + "role='content'></div></div>"),
                l = a("<div>", {
                ...
                r = a("<ul>", {
                    ...
                    role: "listbox",
                    "aria-labelledby": o
                }).attr("data-" + a.mobile.ns + "theme", b.options.theme).appendTo(l),
                n = a("<div>", {
            ...
            a.extend(b, {
                ...
                _buildList: function () {
                    ...
                    for (var n = k.createDocumentFragment(), o, p = 0; p < g; p++) {
                        ...
                        s !== j && s.nodeName.toLowerCase() === "optgroup" && (s = s.getAttribute("label"), s != o && (o = k.createElement("li"), o.setAttribute(h, "list-divider"), o.setAttribute("role", "option"), o.setAttribute("tabindex", "-1"), o.appendChild(k.createTextNode(s)), n.appendChild(o), o = s));
        ...
        a.widget("mobile.fixedtoolbar", a.mobile.widget, {
            options: {
                ...
                supportBlacklist: function () {
                    var a = s,
                        ...
                        h = !! g && g[1];
                    return (e.indexOf("iPhone") > -1 || e.indexOf("iPad") > -1 || e.indexOf("iPod") > -1) && f && f < 534 || a.operamini && {}.toString.call(a.operamini) === "[object OperaMini]" || g && h < 7458 || b.indexOf("Android") > -1 && f && f < 533 || d && d < 6 || "palmGetResource" in s && f && f < 534 || b.indexOf("MeeGo") > -1 && b.indexOf("NokiaBrowser/8.5.0") > -1 ? true : false
                },
            ...
            _create: function () {
                var a = this.options,
                    ...
                    f = b.closest(".ui-page");
                a.supportBlacklist() ? this.destroy() : (b.addClass("ui-" + e + "-fixed"), a.fullscreen ? (b.addClass("ui-" + e + "-fullscreen"), f.addClass("ui-page-" + e + "-fullscreen")) : f.addClass("ui-page-" + e + "-fixed"), this._addTransitionClass(), this._bindPageEvents(), this._bindToggleHandlers())
            },
                ...
                function () {
                    ...
                    if (b.trackPersistentToolbars) {
                        var d = a(".ui-footer-fixed:jqmData(id)", this),
                            ...
                            h = d.length && f.nextPage && a(".ui-footer-fixed:jqmData(id='" + d.jqmData("id") + "')", f.nextPage),
