    ...
    a.flexslider = function (c, b) {
        ...
        d.init = function () {
            ...
            if (d.vars.directionNav) {
                var v = a('<ul class="flex-direction-nav"><li><div class="gw-left"><a class="prev" href="#"></a></div></li><li><div class="gw-right"><a class="next" href="#"></a></div></li></ul>');
                if (d.containerExists) {
