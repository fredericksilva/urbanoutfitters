...
jQuery(function () {
    ...
    jQuery('.quickLinkBox a').click(function (e) {
        ...
        jQuery('#loadhere').html('<img src="/content/ebiz/urbanoutfitters/resources/images/signin_loader.gif" alt="loading" class="loading">').load(jQuery(this).attr('href')).dialog({
        ...
        jQuery('.ui-dialog-titlebar').css({ 'width': '10px' });
